...
float getShadowPCF(
    ...
    OPT_ARG_DECLARATION_jitter) {
     ...
     res += texture2DShadowLerp(depths, size, uv + biasPCF, compare, clampDimension OPT_ARG_INSTANCE_outDistance OPT_ARG_INSTANCE_jitter);
...
#define TSF(o1,o2) texture2DShadowLerp(depths, size, uv + vec2(o1, o2) + biasPCF, compare, clampDimension OPT_ARG_INSTANCE_outDistance OPT_ARG_INSTANCE_jitter)
